...
//        double elapsedTime = getSeconds() - startTime;
        ...
        for (int i = 0; i < lights.length; i++) {
            ...
            shader.setVec3(gl, "lights[" + i + "].direction", new Vec3(0.8f,-1,0));
            shader.setFloat(gl,"lights[" + i + "].cutOff",(float) Math.cos(Math.toRadians(10)));
            shader.setFloat(gl,"lights[" + i + "].outerCutOff",(float) Math.cos(Math.toRadians(15)));

            shader.setFloat(gl,"lights[" + i + "].constant", 1f);
            shader.setFloat(gl,"lights[" + i + "].linear", 0.022f);
            shader.setFloat(gl,"lights[" + i + "].quadratic", 0.0019f);
            shader.setInt(gl,"lights[" + i + "].type",0);
        }
        //type of spotlight:1
        shader.setInt(gl,"lights[2].type",1);
